      ...
      <Container className="flex items-center gap-3 py-3">
        <div className="min-w-0">
          <div className="truncate text-sm font-semibold tracking-tight text-foreground">
            Ready to build your dream yard?
          </div>
          <div className="truncate text-xs text-muted">Call or get a free estimate</div>
        </div>
        <div className="ml-auto flex shrink-0 gap-2">
          ...
          <a
            href="#quote"
            className="inline-flex items-center justify-center rounded-full bg-green px-5 py-3 text-sm font-medium tracking-tight text-white transition hover:bg-[color-mix(in_oklab,var(--green)_88%,white)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Get Estimate
          </a>
        </div>
